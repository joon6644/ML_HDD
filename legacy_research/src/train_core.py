...
def evaluate_saved_models( # 행 단위 평가를 기준으로 삼음 (구버전이며, 현재는 전혀 사용하지 않음)
...
def run_training(
    ...
    *,
    ...
    expected_subsets = len(subset_files) if subset_files else 5
    if expected_subsets == 0:
        expected_subsets = 5
                ...
                if interactive_rerank:
                    ...
                    while True:
                        ...
                        try:
                            ...
                            print("  ⚠️ 에러: 숫자와 쉼표(,) 또는 'auto'만 입력하셔야 합니다. 다시 입력해주세요.")
