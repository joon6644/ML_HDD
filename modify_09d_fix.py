...
new_code = r"""window_days = cfg.TEMPORAL_WINDOW_DAYS
...
for cell in nb['cells']:
    if cell.get('cell_type') == 'code':
        ...
        if 'window_days = cfg.TEMPORAL_WINDOW_DAYS' in src and 'df_window' in src:
            # properly create list of lines ending with actual newline character
            cell['source'] = [line + '\n' for line in new_code.split('\n')]
            # remove the very last newline from the final element
...
print("Updated 09d notebook correctly.")
